    ...
    <>
      ...
      {active && layerState.positions.length > 0 && (
        <div className="fixed inset-0 z-[100] pointer-events-none">
          ...
          <div
            data-egg-control
            className={`fixed bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-0.5 bg-[#1C1C1C]/70 backdrop-blur-md rounded-full p-1.5 pointer-events-auto transition-all duration-300 ${
