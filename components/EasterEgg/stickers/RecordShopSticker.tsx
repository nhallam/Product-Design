  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '10px 16px 8px' }}>
        <div style={{ fontFamily: GROTESK, fontWeight: 900, fontSize: '28px', lineHeight: 1.2, letterSpacing: '0.01em' }}>
      ...
      {!ghost && (
        <div style={{ padding: '4px 16px 10px' }}>
          ...
          >
            <span style={{ fontFamily: GROTESK, fontWeight: 900, fontSize: '28px', lineHeight: 1.2, letterSpacing: '0.01em' }}>
              DIRECTIONS
            </span>
          </a>
