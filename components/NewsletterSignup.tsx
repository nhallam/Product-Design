        ...
        <div className="flex flex-col md:flex-row md:items-center gap-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-1 gap-0">
            <input
              ...
              required
              className="flex-1 min-w-0 text-base px-4 py-3 border border-[#E0E0E0] bg-white text-[#1C1C1C] placeholder-[#aaa] focus:outline-none focus:border-[#1C1C1C] transition-colors rounded-l-md"
            />
            <button
              type="submit"
              disabled={status === 'loading'}
              className="text-base px-6 py-3 bg-[#1C1C1C] text-white hover:bg-[#333] transition-colors disabled:opacity-50 cursor-pointer shrink-0 rounded-r-md"
            >
