    ...
    <main className="flex-1 flex flex-col px-6 pb-16">
      ...
      <div
        className="mt-16 max-w-prose mx-auto w-full
          ...
          [&_blockquote]:border-l-2 [&_blockquote]:border-[#1C1C1C]/20 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:mb-5 [&_blockquote]:text-[#555]
          [&_figure]:my-8
          [&_figure_img]:w-full [&_figure_img]:rounded-sm
          [&_figcaption]:text-sm [&_figcaption]:text-[#888] [&_figcaption]:mt-2
